...
<form method="post"> 
    ...
    <div class="tab-content"> 
        <div role="tabpanel" class="tab-pane active" id="et"> 
            <div class="form-group"> 
                ...
                <input value="<?php echo isset($product->name) ? $product->name : ''; ?>" name="name[et]" type="text" class="form-control" id="name" placeholder=" <?php echo translate('add_name'); ?>"> 
            </div> 
            <div class="form-group"> 
                <label for="name"> <?php echo translate('price'); ?></label> 
                <input value="<?php echo isset($product->price) ? $product->price : ''; ?>" name="price[et]" type="text" class="form-control" id="price" placeholder=" <?php echo translate('add_price'); ?>"> 
            </div> 
            <div class="form-group"> 
        ...
        <div role="tabpanel" class="tab-pane" id="en"> 
            <div class="form-group"> 
                <label for="name"> <?php echo translate('name'); ?></label> 
                <input value="<?php echo isset($product->name) ? $product->name : ''; ?>" name="name[en]" type="text" class="form-control" id="name" placeholder=" <?php echo translate('add_name'); ?>"> 
            </div> 
            <div class="form-group"> 
                <label for="name"> <?php echo translate('price'); ?></label> 
                <input value="<?php echo isset($product->price) ? $product->price : ''; ?>" name="price[en]" type="text" class="form-control" id="price" placeholder=" <?php echo translate('add_price'); ?>"> 
            </div> 
            <div class="form-group"> 
                <label for="description"> <?php echo translate('product_description'); ?></label> 
    ...
    <div class="form-group"> 
        <label for="parent"> <?php echo translate('category'); ?></label> 
    ...
    <div class="checkbox"> 
        <label> 
            <input name="status" type="checkbox" 
                <?php echo isset($product->status) && $product->status == 1 ? 'checked' : '';?>> <?php echo translate('status'); ?> 
        </label> 
    </div> 
    <button type="submit" value="add" name="action" class="btn btn-default"> <?php echo translate('create'); ?></button> 
</form>
