...
<form method="post"> 
    <div class="form-group"> 
        ...
        <input value="<?php echo isset($category->name) ? $category->name : ''; ?>" name="name" type="text" class="form-control" id="name" placeholder="<?php echo translate('add_name' ); ?>"> 
    </div> 
    <div class="form-group"> 
        <label for="parent"><?php echo translate('parent'); ?></label> 
    ...
    <div class="checkbox"> 
        <label> 
            <input name="status" type="checkbox" 
                <?php echo isset($category->status) && $category->status == 1 ? 'checked' : '';?>> <?php echo translate('status'); ?>
        </label> 
    </div> 
