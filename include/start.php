...
defined('PX') ? NULL : define('PX', 'auto123_');
 ...
 * */
defined('ROOT_URL') ? null : define('ROOT_URL', 'http://ubuntu.ametikool.ee/~TAK15_Toots/auto123/');
defined('ROOT_PATH') ? null :
define('ROOT_PATH', DS . 'home' .DS.'TAK15_Toots'.DS.'public_html' .DS.'auto123'.DS);
